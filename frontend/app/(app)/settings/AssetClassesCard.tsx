  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">Categorize your instruments into broad asset classes.</p>
      </div>
      ...
      <div className="space-y-3">
        <h4 className="text-xs font-bold uppercase tracking-widest text-slate-500 ml-1">Configured Classes</h4>
        {loading && items.length === 0 ? (
          ...
          <div className="text-center p-12 bg-slate-50 dark:bg-slate-900/20 rounded-2xl border border-dashed border-slate-200 dark:border-slate-800">
            <p className="text-slate-400 font-medium">No asset classes defined.</p>
          </div>
        ) : (
