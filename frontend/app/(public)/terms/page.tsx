...
export const metadata: Metadata = {
  title: "Terms of Service — Portivue",
  description:
    "Terms of Service for Portivue by Mudric Labs: use, eligibility, subscriptions, disclaimers, and limitations of liability.",
};

export default function TermsPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 leading-7 text-zinc-800">
      <h1 className="mb-6 text-3xl font-extrabold tracking-tight">Terms of Service</h1>
      ...
      <section className="mt-8 space-y-6">
        ...
        <h2 className="text-xl font-bold">2) Nature of Services (No Advice)</h2>
        <p>
        ...
        <h2 className="text-xl font-bold">3) Accounts & Security</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-xl font-bold">4) User Content & Data</h2>
        <p>
        ...
        <h2 className="text-xl font-bold">6) Subscriptions & Fees</h2>
        <ul className="list-disc pl-6">
        ...
        <h2 className="text-xl font-bold">12) Suspension & Termination</h2>
        <p>
        ...
        <p>
          These Terms are governed by the laws of <em>[Insert Governing Jurisdiction]</em>, without
          regard to conflict-of-laws principles. Exclusive venue lies in the courts located in{" "}
          <em>[Insert Venue]</em>. You waive any objection to personal jurisdiction and venue.
        </p>

        <h2 className="text-xl font-bold">14) Changes to the Terms</h2>
        <p>
        ...
        <p>
          Questions? <a className="text-blue-600 underline" href="mailto:info@mudric.com">info@mudric.com</a>
        </p>
      </section>
    </main>
  );
