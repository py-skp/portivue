...
export const metadata: Metadata = {
  title: "Privacy Policy — Portivue",
  description:
    "Privacy Policy for Portivue by Mudric Labs: how we collect, use, store, and protect personal and portfolio data.",
};

export default function PrivacyPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-10 leading-7 text-zinc-800">
      <h1 className="mb-6 text-3xl font-extrabold tracking-tight">Privacy Policy</h1>
      ...
      <section className="mt-8 space-y-6">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>
            <b>Cookies & Similar Tech:</b> See our <a className="text-blue-600 underline" href="/cookies">Cookies Policy</a>.
          </li>
        </ul>
        ...
        <h2 className="text-xl font-bold">3) Legal Bases (GDPR)</h2>
        <ul className="list-disc pl-6">
        ...
        <p>
          ...
          <a className="text-blue-600 underline" href="mailto:info@mudric.com">
            info@mudric.com
          </a>.
        </p>
        ...
        <h2 className="text-xl font-bold">10) No Financial Responsibility</h2>
        <p>
