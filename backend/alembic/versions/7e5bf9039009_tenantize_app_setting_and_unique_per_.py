"""tenantize app_setting and unique per user

Revision ID: 7e5bf9039009
Revises: 24c9435e758d
Create Date: 2025-09-19 23:06:06.892956
...
revision: str = '7e5bf9039009'
down_revision: Union[str, Sequence[str], None] = '24c9435e758d'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_app_setting_owner', 'app_setting', ['owner_user_id'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('uq_app_setting_owner', 'app_setting', type_='unique')
