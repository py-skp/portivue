"""unique account (owner_user_id, name)

Revision ID: 24c9435e758d
Revises: 274ad99a0574
Create Date: 2025-09-19 18:29:28.707407
...
revision: str = '24c9435e758d'
down_revision: Union[str, Sequence[str], None] = '274ad99a0574'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_account_owner_name', 'account', ['owner_user_id', 'name'])
