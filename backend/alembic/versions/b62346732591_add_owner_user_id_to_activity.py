"""Add owner_user_id to activity

Revision ID: b62346732591
Revises: 7e5bf9039009
Create Date: 2025-09-20 17:44:08.316987
...
revision: str = 'b62346732591'
down_revision: Union[str, Sequence[str], None] = '7e5bf9039009'
...
def upgrade() -> None:
    ...
    op.alter_column('activity', 'owner_user_id',
