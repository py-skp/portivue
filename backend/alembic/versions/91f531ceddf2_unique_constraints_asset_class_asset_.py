"""unique constraints asset_class & asset_subclass

Revision ID: 91f531ceddf2
Revises: 5dc9be399103
Create Date: 2025-09-19 18:21:56.402925
...
revision: str = '91f531ceddf2'
down_revision: Union[str, Sequence[str], None] = '5dc9be399103'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('uq_asset_class_owner_name', 'asset_class', ['owner_user_id', 'name'])
    op.create_unique_constraint('uq_asset_subclass_owner_name', 'asset_subclass', ['owner_user_id', 'name'])
    op.create_unique_constraint('uq_sector_owner_name', 'sector', ['owner_user_id', 'name'])
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_constraint('uq_sector_owner_name', 'sector', type_='unique')
    op.drop_constraint('uq_asset_subclass_owner_name', 'asset_subclass', type_='unique')
    op.drop_constraint('uq_asset_class_owner_name', 'asset_class', type_='unique')
